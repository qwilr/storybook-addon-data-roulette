...
var Tool = function () {
    ...
    var spinIndex = addonState.spinIndex, items = addonState.items;
    ...
    return (React.createElement(ToolButton, { "aria-label": label, title: label, onClick: handleSpin, disabled: !hasItems },
